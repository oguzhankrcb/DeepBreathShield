...
LDLIBSOPTIONS=-I/usr/local/include -L/usr/local/lib -L/usr/local/lib/mysql -lmysqlclient -pthread -lz -lm
...
${OBJECTDIR}/src/hooks/CharacterDestructor.o: src/hooks/CharacterDestructor.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/src/hooks
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/hooks/CharacterDestructor.o src/hooks/CharacterDestructor.cpp

${OBJECTDIR}/src/hooks/MoveHook.o: src/hooks/MoveHook.cpp nbproject/Makefile-${CND_CONF}.mk
	${MKDIR} -p ${OBJECTDIR}/src/hooks
	${RM} "$@.d"
	$(COMPILE.cc) -g -Wall -Isrc -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/hooks/MoveHook.o src/hooks/MoveHook.cpp
